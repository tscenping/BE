...
// 우리가 필요한 정보를 함께 담은 custom socket type
export type SocketWithAuth = Socket & WsPayload;
...
export class SocketIoAdapter extends IoAdapter {
	...
	createIOServer(port: number, options?: any) {
		...
		const jwtConfigure: ConfigType<typeof jwtConfig> =
			this.app.get(jwtConfig.KEY);
